...
para compilar:
```terminal
gcc .\src\main.c -o chillq.exe -I .\include\ -L .\lib\ -lmingw32 -lSDL2main -lSDL2 -lSDL2_image
```
...
> [!NOTE]
> - por questão de facilidade, já tem o `.exe` na própria build quando clonar o git<br>
